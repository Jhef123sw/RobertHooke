...
class VariableControl(models.Model):
    ...
    Ge_Pre = models.IntegerField(default= 4)
    Tr_Pre = models.IntegerField(default=4)
    Fi_Pre = models.IntegerField(default=5)
    Qu_Pre = models.IntegerField(default= 5)
    Bi_Pre = models.IntegerField(default=9)
    Le_Pre = models.IntegerField(default=6)
    Lit_Pre = models.IntegerField(default=6)
    Hi_Pre = models.IntegerField(default=3)
    Gf_Pre = models.IntegerField(default=2)
    ...
    Ge_Sem = models.IntegerField(default= 0)
    Tr_Sem = models.IntegerField(default=0)
    Fi_Sem = models.IntegerField(default=0)
    Qu_Sem = models.IntegerField(default= 0)
    Bi_Sem = models.IntegerField(default=0)
    Le_Sem = models.IntegerField(default=0)
    Lit_Sem = models.IntegerField(default=5)
    Hi_Sem = models.IntegerField(default=0)
    Gf_Sem = models.IntegerField(default=0)
