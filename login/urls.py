...
urlpatterns = [
    ...
    path('/reportes/exportar_pdf/<str:nivelSeleccionado>/<str:fechaSeleccionada>/', exportar_pdf, name = 'exportar_pdf'),
    ...
    #Cursos
    path('editar-costo-hora/', editar_costo_hora, name='editar_costo_hora'),
